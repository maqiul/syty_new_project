...
('order:export', '导出订单', 'BUTTON', 'order', 7) ON CONFLICT (code) DO NOTHING;
...
('player:delete', '删除球员', 'BUTTON', 'assets', 13) ON CONFLICT (code) DO NOTHING;
...
('racket:delete', '删除球拍', 'BUTTON', 'assets', 23) ON CONFLICT (code) DO NOTHING;
...
('string:delete', '删除球线', 'BUTTON', 'assets', 33) ON CONFLICT (code) DO NOTHING;
...
('supplier:delete', '删除供应商', 'BUTTON', 'assets', 43) ON CONFLICT (code) DO NOTHING;
...
('stock:check', '库存盘点', 'BUTTON', 'inventory', 4) ON CONFLICT (code) DO NOTHING;

-- 财务管理
INSERT INTO sys_permission (code, name, type, parent_code, sort_order) VALUES
('finance:view', '查看财务', 'BUTTON', 'finance', 1),
('finance:repay', '还款操作', 'BUTTON', 'finance', 2) ON CONFLICT (code) DO NOTHING;
...
('commission:delete', '删除提成规则', 'BUTTON', 'commission', 4) ON CONFLICT (code) DO NOTHING;
...
('shop:delete', '删除门店', 'BUTTON', 'shop', 4) ON CONFLICT (code) DO NOTHING;
...
('print:template:delete', '删除打印模板', 'BUTTON', 'print', 4) ON CONFLICT (code) DO NOTHING;
